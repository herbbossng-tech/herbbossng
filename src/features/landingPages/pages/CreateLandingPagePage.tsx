...
import { useCreateLandingPage } from '@/features/landingPages/hooks'
  ...
  return (
    <div className="flex flex-col gap-5">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">Start from a template — you can fully customize sections and packages after creating it.</p>
      </div>
        ...
        <CardContent>
          <form onSubmit={handleSubmit(submit)} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <Input id="name" placeholder="e.g. Herbal Detox — Facebook Funnel" {...register('name')} aria-invalid={!!errors.name} />
